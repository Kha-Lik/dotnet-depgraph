...
public sealed class IntegrationTests
{
    ...
    public void WritesOfflineReportWithEscapedEmbeddedDataAndControls()
    {
        ...
        try
        {
            ...
            foreach (var file in new[] { "index.html", "graph.json", "diagnostics.json", "summary.md", "graph.graphml", "viewer.js", "viewer.css", "manual-geometry.js", "manual-state.js", "manual-storage.js", "manual-layout.js", "manual-view.js", "cytoscape.min.js", "d3-dispatch.min.js", "d3-quadtree.min.js", "d3-timer.min.js", "d3-force.min.js", "THIRD-PARTY-NOTICES.txt" }) Assert.True(File.Exists(Path.Combine(temp, file)), file);
